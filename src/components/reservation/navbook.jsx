...
export default function Navbook() {
  ...
  const total = adults * 750 + bootCount * 250 + photoSessionCount * 500 + (weddingService ? 5000 : 0);
  ...
  return (
    <div className="container mt-5">
      ...
      <li className={`nav-item mr-2 ${activeComponent === 'overview' ? 'active' : ''}`}>
        <NavLink
      ...
      <li className={`nav-item mr-2 ${activeComponent === 'program' ? 'active' : ''}`}>
        <NavLink
      ...
      <li className={`nav-item mr-2 ${activeComponent === 'includedExcluded' ? 'active' : ''}`}>
        <NavLink
            ...
            <div className="card-body mb-1 mr-auto children-adult">
              ...
              <div className="form-group row">
                ...
                <label htmlFor="boot" className="col-sm-4 col-form-label">
                  <h5>Boot <br /> (250 EGP)</h5>
                  <p className='text-secondary' > Boat cruise with a snorkeling stop</p>
                </label>
                <div className="col-sm-6">
                  <div className="input-group we">
                    <i
              ...
              <div className="form-group row">
                <label htmlFor="photoSession" className="col-sm-4 col-form-label">
                  <h5> Photo Session <br />(500EGP)</h5>
                </label>
                <div className="col-sm-6">
                  <div className="input-group we">
                    <i
                ...
                <div className="col-sm-12 offset-sm-0 mb-5">
                  <div className="form-check">
                    ...
                    <label className="form-check-label" htmlFor="weddingService">
                     <h5> Wedding Service <br /> (5000 EGP for package) </h5>
                    </label>
                  </div>
                </div>
              </div>
