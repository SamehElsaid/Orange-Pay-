...
const Videos = () => {
  ...
  const filteredVideos =
    activeFilter === 'All' ? videos : videos.filter((video) => video.type === activeFilter);
...
<p className="slider-description">Orange Bay hosts a variety of Videos and bars scattered around the island</p>
