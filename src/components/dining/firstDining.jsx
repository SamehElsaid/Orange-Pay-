...
export default function FirstDining() {
  return (
    <div>
        ...
        <p className="slider-description">Orange Bay hosts a variety of restaurants and bars scattered around the island</p>
      </div>
  ...
  <p class="section-description">
    Orange Bay hosts a variety of restaurants and bars scattered around the island to cater to all our guests needs;
    from private dining, family gatherings to party <br /> <br /> and events. We have thought of everything for you to have the perfect
    experience. Enjoy lunch, dinner, cocktails, business meetings, or parties at any of our locations. <br /> <br /> Please select a
    location to view the facilities that are available and that suit your needs.
  </p>
